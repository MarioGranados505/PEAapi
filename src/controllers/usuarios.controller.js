...
export const updateUsuario = async (req, res) => {
    ...
    const [result] = await pool.query(
        'UPDATE usuarios SET Nombre = IFNULL(?, Nombre), Apellido = IFNULL(?, Apellido), Correo = IFNULL(?, Correo), Password = IFNULL(?, Password) Where Idusuario = ?',[Nombre, Apellido, Correo, Password, req.params.id]
    )
